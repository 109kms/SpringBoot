...
class ApplicationTests {
  ...
  void createEmployeeTest() {
    ...
    Name name = Name.createName("길동", "고");
  ...
  void createCompanyTest() {
    ...
    Contact contact = Contact.createContact("admin@example.com", "02-111-1111", "02-111-1000");
    Address address = Address.createAddress("02345", "seoul", "gangnam-street 123");
    ...
    try {
      ...
      foundCompany.getAddress().setStreetAddr("incheon ave 123");

...
public class HomeController {
  ...
  public String value(Model model, HttpSession session) {
    ...
    model.addAttribute("nickname", "<h3>UltraMan</h3>");
    model.addAttribute("board", new BoardDTO(1L, "제목", "내용", LocalDateTime.now()));
    
    session.setAttribute("forecast", Map.of("weather", "rainy", "temperature", 25));
    return "value";
  }
  ...
  public String utility(Model model) {
    ...
    model.addAttribute("authors", Arrays.asList("김처루", "이영의"));
